...
namespace ExcelExport
{
    ...
    {/// <summary>
        ...
        protected static void CreateHeader(HSSFSheet excelSheet)
        {
            ...
            foreach (KeyValuePair<string, string> de in ListColumnsName)
            {
        ...
        protected static void InsertRow(DataTable dtSource, HSSFWorkbook excelWorkbook)
        {
            ...
            //日期格式化
            HSSFCellStyle timeCellStyle = (HSSFCellStyle)excelWorkbook.CreateCellStyle();
            foreach (DataRow dr in dtSource.Rows)
            {
                ...
                InsertCell(dtSource, dr, newRow, newsheet, excelWorkbook, timeCellStyle);
            }
        }
        /// <summary>
        /// 导出数据行
        ...
        /// <param name="excelSheet"></param>
        /// <param name="excelWorkBook"></param>
        protected static void InsertCell(DataTable dtSource, DataRow drSource, HSSFRow currentExcelRow, HSSFSheet excelSheet, HSSFWorkbook excelWorkBook, HSSFCellStyle timeCellStyle)
        {
            ArrayList akeys = new ArrayList(ListColumnsName.Keys);
            ...
            for (int cellIndex = 0; cellIndex < ListColumnsName.Count; cellIndex++)
            {
                ...
                string columnsName = akeys[cellIndex].ToString();
                ...
                switch (rowType.ToString())
                {
                    ...
                    case "System.DateTime"://日期类型
                        ...
                        timeCellStyle.DataFormat = format.GetFormat("yyyy-mm-dd hh:mm:ss");
                        //格式化显示
                        newCell.CellStyle = timeCellStyle;
