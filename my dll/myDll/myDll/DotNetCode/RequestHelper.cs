...
namespace RM.Common.DotNetCode
{
    ...
    public class RequestHelper
    {
        ...
        /// <returns></returns>
        public static Hashtable getDataFromRequestForm(HttpContext context)
        {
            ...
            {
                ht.Add(nv.GetKey(i), nv.GetValues(i)[0]);
            }
            return ht;
        }
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public static Hashtable getDataFromRequestForm_1(HttpContext context)
        {
            Hashtable ht = new Hashtable();
            NameValueCollection nv = new NameValueCollection();
            nv = context.Request.Form;
            ...
            if (ht.Contains("__VIEWSTATE"))
            {
                ht.Remove("__VIEWSTATE");
            }

            if (ht.Contains("__VIEWSTATEGENERATOR"))
            {
                ht.Remove("__VIEWSTATEGENERATOR");
            }
            return ht;
        }
    }
