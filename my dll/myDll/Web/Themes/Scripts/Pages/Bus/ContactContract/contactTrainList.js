...
$(document).ready(function () {
    ...
    $('#tt').datagrid({
        ...
        pageList: [10, 15, 30],
        singleSelect: true,
        url: '/ashx/Contract/contractData.ashx?module=htpagelistByHK&transport=铁路', //获取要创建关联的合同
        columns: [[
        ...
        },
             {
                 ...
                 handler: function () {
                     ...
                     if (row != undefined) {
                         ...
                         no = row.contractNo;
                         window.top.addNewTab('生成关联合同', '/Bus/ContactContract/contactTrainForm.aspx?contractNo=' + no + '&createDateTag=' + row.createDateTag+'&transport=铁路', "");
                     } else {
                         $.messager.alert('提示', '请选择一行数据！', 'info');
                     }
                 }
