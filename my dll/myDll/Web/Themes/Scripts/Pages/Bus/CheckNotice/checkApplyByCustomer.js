...
function addProductlist() {
    ...
    $('#productname').datagrid({
        url: '/ashx/Contract/contractData.ashx?module=traincplist',
        singleSelect: true,
        pagination: false,
...
function add() {
    ...
    window.top.addNewTab("海运订舱申请-新增", '/Bus/CheckOutNotice/checkApplyByCustomerForm.aspx?action=add', '');
}
//修改
function edit() {
    var no = '';
    ...
    window.top.addNewTab("海运订舱申请-修改", '/Bus/CheckOutNotice/checkApplyByCustomerForm.aspx?action=edit&checkId=' + no, '');
}
