...
function add() {
    ...
    window.top.addNewTab("海运订舱-新增", '/Bus/CheckOutNotice/checkNoticeByCustomerForm.aspx?action=add', '');
}
//修改
function edit() {
    var no = '';
    ...
    window.top.addNewTab("海运订舱-修改", '/Bus/CheckOutNotice/checkNoticeByCustomerForm.aspx?action=edit&checkId=' + no, '');
}
