...
$(function () {
    ...
    $('#htcplist').datagrid({
        ...
        columns: [[
                    ...
                    {
                        field: 'qunit', title: '数量单位', width: 100, formatter: function (value, row, index) {
    ...
    $('#tt').tabs({
        ...
        onSelect: function (title) {
            ...
            if (title == "查看合同文本") {
                ...
                //           var url = "/Bus/Contract/priviewTemplate.aspx"; //定义iframe页面的form表单的action
                //           var html1 = '<form id="queryForm" name="queryForm" method="post" target="_self" action="' + url + '">' +
                //'<input type="hidden" id="templatejson" name="templatejson" value="' + templatejson + '"/>' +      //pk_id是一个长度超过3000字符的值
                //'</form>';
                //           document.getElementById('previewFormFrame').contentWindow.document.write(html1);  //将表单写入iframe中
                //           document.getElementById('previewFormFrame').contentWindow.document.getElementById('queryForm').submit();//执行iframe中表单的提交

                $("#previewFormFrame").attr('src', '/Bus/Contract/priviewTemplate.aspx?buyer=' + buyer + '&buyercode=' + buyercode + '&seller=' + seller + '&sellercode=' + sellercode + '&validity=' + validity + '&language=' + language + '&templateno=' + templateno + '&signedTime=' + signedTime + '&signedplace=' + signedplace + '&productlist=' + datagridjson
                ...
                $(":checkbox").click(function () {
                    ...
                    $("#previewFormFrame").attr('src', '/Bus/Contract/priviewTemplate.aspx?buyer=' + buyer + '&buyercode=' + buyercode + '&seller=' + seller + '&sellercode=' + sellercode + '&validity=' + validity + '&language=' +
                        + '&templateno=' + templateno + '&signedTime=' + signedTime + '&signedplace=' + signedplace + '&productlist=' + datagridjson
                    + '&tradement=' + tradement + '&transport=' + transport + '&harborout=' + harborout + '&harborarrive=' + harborarrive
                      + '&deliveryPlace=' + deliveryPlace + '&pricement1=' + pricement1 + '&pricement2=' + pricement2 + '&validity=' + validity
                        + '&pvalidity=' + pvalidity + '&shipment=' + shipment + '&placement=' + placement + '&moreLanguage=' + str);
