...
//    });
    ...
    $('#tt_subTable').datagrid({
        ...
        columns: [[
            ...
            { field: 'number', title: '通知件数', width: '100px' },
            { field: 'outquantity', title: '通知数量', width: '100px' },
            { field: 'realnumber', title: '实发件数', width: '100px', editor: 'numberbox' },
            { field: 'realoutquantity', title: '实发数量', width: '100px', editor: { type: 'numberbox', options: { precision: 3 } } },
            { field: 'indate', title: '入库时间', width: '80px' },
            { field: 'remark', title: '备注', width: '100px', editor: 'text' }
            ]],
        pagination: true,
        toolbar: toolbar,
...
//        sortName: 'wcode',
//        sortOrder: 'asc',
//        url: '/Bus/StockManage/StockEntityHandler.ashx?action=stockswiftlist',
//        columns: [[
//                    { field: 'wname', title: '仓库', width: 60 },
//                    { field: 'owner', title: '货权所属方', width: 120 },
//                    { field: 'mcode', title: 'SAP编码', width: 120 },
...
//                    { field: 'quantity', title: '库存件数', width: 120 }
//            ]]
//    });
}
//添加
...
function save() {
    ...
    var form = $("#form1");
    form.form('submit', {
        url: "/Bus/StockManage/StockEntityHandler.ashx?action=confirmout&status2=待发货",
        onSubmit: function () {
            //进行表单验证 
            return valiForm();
        },
...
var submit = function () {
    ...
    var form = $("#form1");
    form.form('submit', {
        url: "/Bus/StockManage/StockEntityHandler.ashx?action=confirmout&status2=已发货",
        onSubmit: function () {
            //进行表单验证 
            console.log("正在表单验证！");
            valiForm();
