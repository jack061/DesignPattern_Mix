...
namespace RM.DataBase
{
    ...
    public interface IDbHelper
    {
        ...
        /// <param name="param">参数化</param>
        /// <returns></returns>
        int BatchExecuteByListSql(List<StringBuilder> sql, List<object> param);
        int BatchExecuteByListSql(List<StringBuilder> sql, List<object> param,ref string err);
        int BatchExecuteBySql(List<StringBuilder> sql);
        #endregion
        ...
        /// <returns></returns>
        int getInt(StringBuilder sql, SqlParam[] param, string columnName);
        /// <summary>
        /// 获取int
        /// </summary>
        /// <param name="sql"></param>
        ...
        /// <param name="columnName"></param>
        /// <returns></returns>
        int getInt(StringBuilder sql, string columnName);
        /// <summary>
        /// 获取某一列的值
        /// </summary>
        /// <param name="sql"></param>
        ...
        /// <param name="columnName"></param>
        /// <returns></returns>
         string getString(StringBuilder sql, SqlParam[] param, string columnName);
         ...
         /// <param name="columnName"></param>
         /// <returns></returns>
         string getString(StringBuilder sql, string columnName);
        #endregion
        ...
        /// <param name="sql">SQL</param>
        /// <returns></returns>
        DataTable GetDataTableBySQL(StringBuilder sql, int flag);
        /// <summary>
        ...
        /// <param name="param">参数化</param>
        /// <returns></returns>
        DataTable GetDataTableBySQL(StringBuilder sql, SqlParam[] param,int flag);
        /// <summary>
        /// 摘要:
        ///     执行一存储过程DataTable
        /// 参数：
        ...
        /// </summary>
        /// <returns></returns>
        bool Submit_AddOrEdit_1(string tableName, string pkName, string pkVal, Hashtable ht);
        bool Submit_AddOrEdit_2(string tableName, string pkName, string pkVal, string pkName2, string pkVal2, Hashtable ht);
        /// <summary>
        /// 根据唯一ID获取Hashtable
        /// </summary>
        ...
        int IsExist2(string tableName, string pkName, string pkVal1,string pkName2,string pkVal2);
        int IsExist3(string tableName, Hashtable ht_prime);
        /// <summary>
        /// 通过Hashtable插入数据
        /// </summary>
        ...
        int UpdateByHashtable3(string tableName, string pkName, string pkVal, Hashtable ht);
        /// <summary>
        /// 删除数据
        /// </summary>
        ...
        /// <returns></returns>
        StringBuilder GetInsertSql(Hashtable ht, string tableName);
        ...
        /// <returns></returns>
        StringBuilder GetUpdateSql(Hashtable ht, string tableName, List<String> keyNames, List<String> keyValues);

        SqlParam[] GetParameter(Hashtable ht);
    }
}
