...
namespace WZX.DataBase.SqlServer
{
    public class SqlServerHelperExpand : SqlServerHelper
    {
        protected string connString = "";

        public SqlServerHelperExpand(string connString)
            : base(connString)
        {
        ...
        //查询数据表中的一个字段
        public DataSet search(string str, string table)
        {
        ...
        ///</summary>
        public DataTable ExecuteSql1(string strSQL, int ParentID)
        {
            using (SqlConnection connection = new SqlConnection(connString))
            {
        ...
        public DataTable ExesqlDT(string strSQL)
        {
            using (SqlConnection connection = new SqlConnection(connString))
            {
                DataTable dt = new DataTable();
